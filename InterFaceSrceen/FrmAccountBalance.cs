...
namespace InterFaceSrceen
{
    public partial class FrmAccountBalance : Form
    {
        ...
        private void FrmAccountBalance_Resize(object sender, EventArgs e)
        {
            AdiustForm();
        ...
        private void PutDataInLabels(clsClientsBusiness client)
        {
            Lb_FullName.Text="Full Name: "+client._FirstName +" "+ client._MiddleName+" "+ client._LastName;
            Lb_AccountBalance.Text="AccountBalance: "+client._AccountBalance.ToString();
            Lb_AccountNumber.Text="Account Number: "+client._AccountNumber;
            Lb_Pincode.Text="Pincode: "+client._Pincode;
        }

        private void Btn_Search_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrWhiteSpace(Txtb_AccountNumber.Text))
            {
                clsClientsBusiness client = clsClientsBusiness.FindAccountByAccountNumber(Txtb_AccountNumber.Text);
                if(client != null) 
                {
                    PutDataInLabels(client);
                }
                else
                {
                    MessageBox.Show("NOT FOUND\n Please Enter Right Account Number","Error",MessageBoxButtons.OK,MessageBoxIcon.Error);
                }
            }
            else 
            {
